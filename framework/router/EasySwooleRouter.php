...
class EasySwooleRouter implements Router
{
    ...
    public function init(App $app)
    {
        ...
        // 设置默认模块
        $this->moduleName     = $this->config->config['route']['defaultModule'];
        // 设置默认控制器
        $this->controllerName = $this->config->config['route']['defaultController'];
        // 设置默认操作
        $this->actionName     = $this->config->config['route']['defaultAction'];
